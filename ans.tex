...
\pandocbounded{\includegraphics[keepaspectratio]{ans_files/figure-pdf/cell-15-output-4.png}}
...
The improved model is trained with no specific max depth, 4
min\_samples\_leaf, 2 min\_samples\_split, and 300 estimators.
